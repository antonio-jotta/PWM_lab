...
int main(void)
{
  ...
  while (1)
  {
    ...
    /* USER CODE BEGIN 3 */
	  ...
	  //Para dar output de mais um sinal PWM, usar o TIM2->CCR2
...
//Testar esta função para usar no HIL/SIL


/*void writePWM(float abertura)
{
	float dutyCicle = 5.26 + abertura*5.10;
	TIM_HandleTypeDef* tim = &htim2;
	TIM2->CCR1 = dutyCicle * tim->Init.Period/100;
}
*/
